/**
 * pixiViewport —— @main-ui/core 渲染基础设施的 PixiJS WebGL 内核。
 *
 * 定位：core 保留相机纯函数（camera/constraints/interactions）作为“视口外壳”，
 ...
 *
 * 视图层（view-world / view-sandbox）拿到 world 容器后往里加世界坐标的
 * Graphics/Sprite/Text，相机由本类唯一管理，杜绝“两套变换并存”。
 *
 * 由原 viewport-2d-kit 的 PixiViewport 吸收而来（包名消灭，功能内化进 core）。
 */
import { Application, Container } from 'pixi.js';
import type { Camera2D, Vec2, ViewBox } from './camera';
import { clamp, fitCameraToViewBox, panBy, screenToWorld, worldToScreen, zoomAtScreenPoint } from './camera';
